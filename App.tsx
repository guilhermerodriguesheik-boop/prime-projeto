...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      // Admin
      case 'admin-dashboard': return <AdminDashboard fuelings={fuelings} maintenances={maintenances} vehicles={vehicles} fixedExpenses={fixedExpenses} dailyRoutes={dailyRoutes} routes={routes} agregadoFreights={agregadoFreights} onBack={() => navigate('operation')} />;
        ...
        <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('operation')}>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1.5">
              <span className="w-1 h-1 rounded-full bg-emerald-500 pulse-emerald"></span>
